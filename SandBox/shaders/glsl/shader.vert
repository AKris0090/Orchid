...
void main() {
    ...
    fragNormal = vec4(normalize(mat3(modelMatrices[gl_BaseInstance]) * inNormal.xyz), inNormal.w);
    fragTangent = vec4(normalize(mat3(modelMatrices[gl_BaseInstance]) * inTangent.xyz), inTangent.w);
