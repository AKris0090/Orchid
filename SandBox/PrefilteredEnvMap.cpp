...
void PrefilteredEnvMap::createPipeline() {
    ...
    std::vector<char> prefEMapVertShader = readFile("./shaders/spv/filterCubeVert.spv");
    std::vector<char> prefEMapFragShader = readFile("./shaders/spv/prefilteredEnvMapFrag.spv");
