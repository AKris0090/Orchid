...
| :---------------------------------------------------------: | :---------------------------------------------------------: |
|                   ![](README_IMAGES/CSM_captures/3.png)              |               ![](README_IMAGES/CSM_captures/2.png)                  |
|                                      Shadow Map Slice 3             |          Shadow Map Slice 4                             |
|                   ![](README_IMAGES/CSM_captures/1.png)              |               ![](README_IMAGES/CSM_captures/0.png)                  |
|                                 Final Output                                                                               |
|                                                         ![](README_IMAGES/CSM_captures/YvUQO8.png)                                            |
